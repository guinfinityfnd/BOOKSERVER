...
<body>
    ...
    <div class="container-fluid">
        ...
        <button class="topButton" onclick="topFunction()">&uarr;</button><br><br>
        <div class="container">
            <div class="row align-items-start">
                ...
                <div class="col-lg-3">
                    <p class="text-break think-style">
                        သင့်ရဲ့ဘဝမှာ ခလုတ်ကန်သင်းတွေပြည့်နေတယ်လို့<span id="dots"
                            style="color: rgb(255, 47, 47); font-size: 1.5em;">...</span><span
                            id="more">သင်မြင်ရင်အဲဒီခလုတ်ကန်သင်းတွေကိုလှေကားထစ်လိုသဘောထားလိုက်ပါ။သင်မြင်ရင်အဲဒီခလုတ်ကန်သင်းတွေကိုလှေကားထစ်လိုသဘောထားလိုက်ပါ။</span>
            ...
            <div class="row align-items-center">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3">
                        <p class="text-break think-style">
                            အပြစ်တင်ခြင်း အပြစ်မြင်ခြင်း၊ကြောက်ရွံ့ခြင်းနဲ့ဖြည့်လို့မပြည့်နိုင်တဲ့ မျှော်လင့်ခြင်း
                            တို့ဟာ လူရဲ့စွမ်းအားကို ဝါးမျိုစားသုံသူကြီးသုံးဦးပါပဲ။
                        </p>
                    </div>
                </div>
                <div class="row align-items-center">
